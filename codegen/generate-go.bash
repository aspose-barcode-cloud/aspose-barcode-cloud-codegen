...
# java -DdebugOperations -jar Tools/openapi-generator-cli.jar generate -i "$specSource" -g go -t Templates/go -o $tempDir -c config-go.json > debugOperations.go.json
