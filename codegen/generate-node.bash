...
java -jar Tools/swagger-codegen-cli.jar generate -i "$specSource" -l typescript-fetch -t Templates/nodejs -o $tempDir -c config.json
...
java -jar Tools/swagger-codegen-cli.jar generate -i "$specSource" -l typescript-fetch -t Templates/nodejs/docs -o $tempDir/docs -c config.json
